...
$CC -T link.ld -o kernel -ffreestanding -O2 -nostdlib boot.o gdt.o interrupt.o nanoprintf.o monitor.o common.o isr.o descriptor_tables.o timer.o paging.o kheap.c main.o -lgcc
